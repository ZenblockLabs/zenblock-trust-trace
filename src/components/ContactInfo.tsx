    ...
    <CardContent className="p-8 space-y-6">
      <div className="flex items-center gap-4">
        <div className="rounded-full bg-zenblock-white p-2">
          <Phone className="w-6 h-6 text-zenblock-leaf-green" />
        </div>
        <div>
      ...
      <div className="flex items-center gap-4">
        <div className="rounded-full bg-zenblock-white p-2">
          <Mail className="w-6 h-6 text-zenblock-leaf-green" />
        </div>
        <div>
      ...
      <div className="flex items-center gap-4">
        <div className="rounded-full bg-zenblock-white p-2">
          <MapPin className="w-6 h-6 text-zenblock-leaf-green" />
        </div>
        <div>
      ...
      <div className="flex items-center gap-4">
        <div className="rounded-full bg-zenblock-white p-2">
          <MessageCircle className="w-6 h-6 text-zenblock-leaf-green" />
        </div>
        <div>
