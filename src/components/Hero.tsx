      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button 
              size="lg" 
              className="bg-white text-zenblock-blue hover:bg-gray-100 text-base px-6 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
            >
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-white text-white hover:bg-white hover:text-zenblock-blue text-base px-6 py-3 rounded-full font-semibold backdrop-blur-sm"
            >
              Book a Demo
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-blue-200 text-sm">Drug Traceability</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white mb-2">3+</div>
              <div className="text-blue-200 text-sm">Countries Compliant</div>
            </div>
            <div className="text-center">
