  ...
  return (
    <section id="about" className="py-12 sm:py-16 lg:py-20 bg-zenblock-pure-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 sm:mb-16">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-zenblock-deep-forest mb-6 sm:mb-8 text-center">Our Core Values</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {values.map((value, index) => (
              <Card key={index} className="text-center bg-white border border-zenblock-border-grey hover:shadow-lg transition-all duration-300 group">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex justify-center mb-3 sm:mb-4">
                    <value.icon className="w-8 h-8 sm:w-10 sm:h-10 text-zenblock-professional-green group-hover:text-zenblock-fresh-green transition-colors duration-300" strokeWidth={1.5} />
                  </div>
        ...
        <div className="mb-12 sm:mb-16">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-zenblock-deep-forest mb-6 sm:mb-8 text-center">Our Journey</h3>
        ...
        <div className="bg-zenblock-mint-whisper border border-zenblock-border-grey rounded-2xl p-8 sm:p-12 text-center">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-zenblock-deep-forest mb-4">Trusted by Regulators and Innovators</h3>
          <p className="text-base sm:text-lg text-zenblock-medium-grey mb-6">
            Across India and UAE
          </p>
          <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-12 opacity-60">
            <div className="text-zenblock-medium-grey font-semibold text-lg">Partner Logos Coming Soon</div>
          </div>
        </div>
      </div>
    </section>
