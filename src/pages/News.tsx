...
const News = () => {
  ...
  return (
    <div className="min-h-screen bg-zenblock-white">
      <SEOHead 
        title="News & Updates | Zenblock Labs"
        description="Latest news and updates from Zenblock Labs. Stay informed about blockchain traceability innovations and partnership announcements."
        canonical="https://www.zenblocklabs.com/news"
      />
      <Navigation />
