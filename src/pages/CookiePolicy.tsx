...
const CookiePolicy = () => {
  return (
    <div className="min-h-screen bg-zenblock-white">
      <SEOHead 
        title="Cookie Policy | Zenblock Labs"
        description="Learn about how Zenblock Labs uses cookies and similar technologies on our website."
        canonical="https://www.zenblocklabs.com/cookie-policy"
      />
      <Navigation />
