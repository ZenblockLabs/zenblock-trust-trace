...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-zenblock-white">
      <SEOHead 
        title="Privacy Policy | Zenblock Labs"
        description="Zenblock Labs privacy policy. Learn how we collect, use, and protect your personal information."
        canonical="https://www.zenblocklabs.com/privacy-policy"
      />
      <Navigation />
